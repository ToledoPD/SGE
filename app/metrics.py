...
def get_product_metrics():
    products = Product.objects.all()  # busca todos os produtos da base de dados
...
def get_sales_metrics():
    ...
    total_sales_cost = sum(outlow.quantity * outlow.product.cost_price for outlow in Outflow.objects.all())
